...
# OI_T4 definition (1st revision, unofficial, used in OITOOLS.jl):
define("OI_T4", 1,
        ["OI_REVN     I    revision number of the table definition",
         "DATE-OBS    A    UTC start date of observations",
         "ARRNAME    ?A    name of corresponding array",
         ...
         "MJD        D(1)  modified Julian Day [day]",
         "INT_TIME   D(1)  integration time [s]",
         "T4AMP      D(W)  triple product amplitude",
         "T4AMPERR   D(W)  error in triple product amplitude",
         "T4PHI      D(W)  triple product phase [deg]",
         "T4PHIERR   D(W)  error in triple product phase [deg]",
         "U1COORD    D(1)  U coordinate of baseline AB of the triangle [m]",
         "V1COORD    D(1)  V coordinate of baseline AB of the triangle [m]",
         "U2COORD    D(1)  U coordinate of baseline BC of the triangle [m]",
         "V2COORD    D(1)  V coordinate of baseline BC of the triangle [m]",
         "U3COORD    D(1)  U coordinate of baseline BC of the triangle [m]",
         "V3COORD    D(1)  V coordinate of baseline BC of the triangle [m]",
         "STA_INDEX  I(4)  station numbers contributing to the data",
         "FLAG       L(W)  flag"])

# OI_T4 definition (2nd revision, unofficial, used in OITOOLS.jl):
define("OI_T4", 2,
     ["OI_REVN     I    revision number of the table definition",
      "DATE-OBS    A    UTC start date of observations",
      "ARRNAME    ?A    name of corresponding array",
